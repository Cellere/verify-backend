...
export class MailService {
    ...
    await this.transporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <h2 style="color: #5e0600;">Comprovante de Pagamento</h2>
          <p>Olá,</p>
          <p>Conforme solicitado, estamos enviando o PDF de vericação.</p>
  ...
  async sendVerificationEmail(email: string, code: string) {
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <h2 style="color: #5e0600;">Bem-vindo à Verify!</h2>
          <p>Olá,</p>
          ...
          <div style="padding: 10px; text-align: center; background-color: #f4f4f4; border: 1px solid #ddd; border-radius: 5px;">
            <h3 style="margin: 0; color: #5e0600;">${code}</h3>
          </div>
